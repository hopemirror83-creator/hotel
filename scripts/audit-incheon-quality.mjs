...
const regionConfig = {
  ...
  gangwon: {
    address: /(강원|Gangwon|속초|강릉|양양|평창|정선|춘천|원주|동해|삼척|태백|홍천|횡성|영월|철원|화천|양구|인제|고성)/i,
    locations: ['속초', '강릉', '양양', '평창', '정선', '춘천', '원주', '동해', '삼척', '태백', '홍천', '횡성', '영월', '철원', '화천', '양구', '인제', '고성', '설악산', '경포대', '경포', '주문진', '낙산', '대관령', '용평', '휘닉스파크', '알펜시아', '하이원', '오크밸리', '남이섬']
  },
  gyeongbuk: {
