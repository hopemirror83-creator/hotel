...
await writeFile('data/target-hotels-chiangmai-v1-generated.json', JSON.stringify(kept, null, 2) + '\n');
await writeFile('data/target-slugs-chiangmai-v1-quality.json', JSON.stringify(kept.map(h => h.slug), null, 2) + '\n');
