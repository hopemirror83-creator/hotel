...
for (const hotel of hotels.filter((item) => item.slug?.startsWith('nghean-'))) {
...
await writeFile('data/target-hotels-nghean-v1-generated.json', `${JSON.stringify(kept, null, 2)}\n`);
await writeFile('data/target-slugs-nghean-v1-quality.json', `${JSON.stringify(kept.map((hotel) => hotel.slug), null, 2)}\n`);
