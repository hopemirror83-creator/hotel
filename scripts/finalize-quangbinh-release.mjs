...
for (const hotel of hotels.filter((item) => item.slug?.startsWith('quangbinh-'))) {
...
await writeFile('data/target-hotels-quangbinh-v1-generated.json', `${JSON.stringify(kept, null, 2)}\n`);
await writeFile('data/target-slugs-quangbinh-v1-quality.json', `${JSON.stringify(kept.map((hotel) => hotel.slug), null, 2)}\n`);
