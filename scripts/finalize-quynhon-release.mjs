...
for (const hotel of hotels.filter((item) => item.slug?.startsWith('quynhon-'))) {
...
await writeFile('data/target-hotels-quynhon-v1-generated.json', `${JSON.stringify(kept, null, 2)}\n`);
await writeFile('data/target-slugs-quynhon-v1-quality.json', `${JSON.stringify(kept.map((hotel) => hotel.slug), null, 2)}\n`);
