...
await writeFile('data/target-hotels-samui-v1-generated.json', JSON.stringify(kept, null, 2) + '\n');
await writeFile('data/target-slugs-samui-v1-quality.json', JSON.stringify(kept.map(h => h.slug), null, 2) + '\n');
