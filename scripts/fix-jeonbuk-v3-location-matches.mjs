...
const candidatePath = 'data/target-hotels-jeonbuk-candidates-v3-expanded.json';
const replacementPath = 'data/target-hotels-jeonbuk-v3-replacements-6.json';
const slugPath = 'data/target-slugs-jeonbuk-v3-200.json';
const replacementSlugPath = 'data/target-slugs-jeonbuk-v3-replacements-6.json';
