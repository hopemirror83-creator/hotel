...
const existing = head.filter((hotel) => !hotel.slug?.startsWith('aomori-'));
const region = JSON.parse(await readFile('data/target-hotels-aomori-v1-generated.json', 'utf8'));
...
console.log({ existing: existing.length, aomori: region.length, total: merged.length });
