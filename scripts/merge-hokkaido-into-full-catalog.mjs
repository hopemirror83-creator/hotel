...
const existing = head.filter((hotel) => !hotel.slug?.startsWith('hokkaido-'));
const region = JSON.parse(await readFile('data/target-hotels-hokkaido-v1-generated.json', 'utf8'));
...
console.log({ existing: existing.length, hokkaido: region.length, total: merged.length });
