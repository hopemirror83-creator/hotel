...
const existing = head.filter((hotel) => !hotel.slug?.startsWith('okayama-'));
const region = JSON.parse(await readFile('data/target-hotels-okayama-v1-generated.json', 'utf8'));
...
console.log({ existing: existing.length, okayama: region.length, total: merged.length });
