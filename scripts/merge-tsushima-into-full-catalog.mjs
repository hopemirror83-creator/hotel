...
const existing = head.filter((hotel) => !hotel.slug?.startsWith('tsushima-'));
const region = JSON.parse(await readFile('data/target-hotels-tsushima-v1-generated.json', 'utf8'));
...
console.log({ existing: existing.length, tsushima: region.length, total: merged.length });
