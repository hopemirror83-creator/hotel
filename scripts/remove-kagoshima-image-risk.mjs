...
const remove = new Set(['kagoshima-687156']);
for (const path of ['data/target-hotels-kagoshima-v1-quality.json']) {
...
const slugPath = 'data/target-slugs-kagoshima-v1-quality.json';
...
await unlink('kagoshima-fallback-check.jpg').catch(() => {});
console.log({ targets: slugs.length, collected: collected.hotels.length, generated: generated.filter((hotel) => hotel.slug.startsWith('kagoshima-')).length });
