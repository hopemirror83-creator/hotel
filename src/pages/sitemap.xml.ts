...
import { dongnaiAreaGuides } from '../data/dongnaiAreaGuides';
...
import { angiangAreaGuides } from '../data/angiangAreaGuides';
import { kiengiangAreaGuides } from '../data/kiengiangAreaGuides';
import { vinhlongAreaGuides } from '../data/vinhlongAreaGuides';
import { tiengiangAreaGuides } from '../data/tiengiangAreaGuides';
...
import { chiangmaiAreaGuides } from '../data/chiangmaiAreaGuides';
import { huahinAreaGuides } from '../data/huahinAreaGuides';
import { chiangraiAreaGuides } from '../data/chiangraiAreaGuides';
...
export const GET: APIRoute = ({ site }) => {
  ...
  const urls = [
    ...
    ...dongnaiAreaGuides.map((guide) => guide.path),
    ...
    ...angiangAreaGuides.map((guide) => guide.path),
    ...kiengiangAreaGuides.map((guide) => guide.path),
    ...vinhlongAreaGuides.map((guide) => guide.path),
    ...tiengiangAreaGuides.map((guide) => guide.path),
    ...
    ...chiangmaiAreaGuides.map((guide) => guide.path),
    ...huahinAreaGuides.map((guide) => guide.path),
    ...chiangraiAreaGuides.map((guide) => guide.path),
